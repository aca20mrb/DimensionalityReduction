...
plt.savefig('housing_silhouette_plot.png')
plt.show()
...
plt.yticks(color='black')
plt.tight_layout(pad=2)  # Adjust the padding to ensure nothing gets cut off
plt.savefig('housing_davies_bouldin_plot.png')
plt.show()
